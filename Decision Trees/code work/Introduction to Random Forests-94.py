...
auc_1 = roc_auc_score(test['high_income'], predict_1)
auc_2 = roc_auc_score(test['high_income'], predict_2) 
print(auc_1)
print(auc_2)
...
mean_pred = np.round((predictions+predictions2)/2)
...
mean_pred = np.round(np.sum(predictions, axis=0)/10)
...
auc = roc_auc_score(test['high_income'], predict)
print(auc)
