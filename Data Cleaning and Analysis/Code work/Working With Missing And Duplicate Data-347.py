...
happiness2015.columns = happiness2015.columns.str.upper().str.strip().str.replace("(","").str.replace(")","")
happiness2016.columns = happiness2016.columns.str.upper().str.strip().str.replace("(","").str.replace(")","")
