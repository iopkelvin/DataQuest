...
dic = {"name": "learning-about-apis"}

response = requests.post("https://api.github.com/user/repos", json=dic, headers=headers)
...
print(response.status_code)
dic = {"description": "Learning about requests!", "name": "learning-about-apis"}
response1 = requests.patch("https://api.github.com/repos/VikParuchuri/learning-about-apis", json= dic, headers=headers)
